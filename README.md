...
Branded slide deck template for **Taylor Geospatial** presentations. Built with Next.js + MDX, themed to the TG brand guide.
...
| `Logo` | TG brandmark + wordmark | `height`, `wordmark` |
...
Colors from the [TG Brand Guide](assets/Brand%20Guide%20Lite.pdf):
...
├── assets/                     # TG brand assets (logos, elements, imagery)
